const { betService, claimService, userBetInfoService, totalBetsInfoService, marketInfoService, withdrawBetService, resolveMarketService, getAdminService, getMarketIsCanceledService } = require("../services/market.service");
...
module.exports = { betController, claimController, userBetInfoController, totalBetsInfoController, marketInfoController, withdrawBetController, resolveMarketController, getAdminController, getMarketIsCanceledController };